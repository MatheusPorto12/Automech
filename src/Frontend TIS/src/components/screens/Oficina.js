...
export function OficinaScreen() {
    ...
    async function getDadosOficina(id){
      ...
      document.getElementById('idOficinaHidden').value = data.id
    ...
    async function fazerOrcamento(id){
      ...
      let obsOficina = document.getElementById('textProblema').value
    ...
    return (
      <>
        ...
        <div className='normalBackground'  id='wrapDados'>
            ...
            <Avaliacao></Avaliacao>
              <Input id='idOficinaHidden' hidden></Input>
            <Modal
