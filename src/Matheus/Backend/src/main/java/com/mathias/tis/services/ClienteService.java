...
import com.mathias.tis.repositories.ClienteRepository;
...
public class ClienteService {
    ...
    public ArrayList<Double> getPeriodo(){
        ...
        for(int i = 1; i <= 4; i++){
            ...
            double crescimento = (depois-antes)/antes*100;
            taxas.add(i-1, Double.isNaN(crescimento) || Double.isFinite(crescimento) ? 0d : crescimento);
        }
