...
import com.horou.Tis.Services.EmailService;
...
public class ReparoController {
    ...
    throws MessagingException{
        ...
        if(updateSuccess > 0){
            ...
            String email = "gab0978br2@gmail.com"; 
            String content = "O status do seu serviço foi atualizado para: Concluído"; 
    
    
            try {
                sendEmail.sendEmailToClient(subject, email, content);
