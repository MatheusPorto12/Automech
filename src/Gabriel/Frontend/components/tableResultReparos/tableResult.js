...
export const TableResultReparos = () => {
    ...
    async function getReparos(){
        ...
        let url = `http://localhost:8081/Reparo/Pesquisar?idOrcamento=${idOrcamento}`
    ...
    async function finalizarReparos(){
        ...
        let url = `http://localhost:8081/Reparo/FinalizarReparo?idReparo=${inputsPost}`
        ...
        <div className="wrap-table">
            <div id="top-itens">
                <Select placeholder='Selecione um orçamento' id="selectOrcamento" variant='filled'>
                    <option value='1'>Orçamento 1</option>
                    <option value='2'>Orçamento 2</option>
                    <option value='3'>Orçamento 3</option>
                </Select>
